...
const Advan = () => {
  return (
    <>
    <section className='relative z-5 w-full bg-white  py-5 '>
        <Dots/>
        <div dir='rtl' className='grid grid-cols-1 lg:grid-cols-2 mx-4 lg:mx-20 relative z-2' >
            <div className= {`col-span-1 ${arabicFont.className} flex flex-col justify-center lg:items-start ml-4 py-10 `}>
                ...
                <p className=' text-sm lg:text-md text-center lg:text-start '>
            ...
            {BestTrip.map((trip, index) => (
                ...
                >
                    ...
                    <div className="absolute top-0 h-full right-0  w-full hidden group-hover:flex items-center justify-center bg-black bg-opacity-75 text-white  font-bold rounded-3xl">
                        <p className={`text-sm ${arabicFont.className} `}>
