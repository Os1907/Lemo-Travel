                ...
                {places.map(place => (
                    <div key={place.name + place.price} className="col-span-3 lg:col-span-2  group">
                        <div className="relative w-full    bg-black shadow-md rounded-3xl p-2 mx-1 my-3 \">
                            ...
                            <div className="mt-4 pl-2 mb-2 flex justify-between relative    ">
                                <div>
                                    ...
                                    <p className="text-center text-black bg-white relative w-0 group-hover:w-full  rounded-3xl  my-1 pb-1  text-xxs lg:text-sm max-h-0 overflow-hidden duration-500 transition-all group-hover:max-h-40 "><TiLocationArrow className='inline text-base' /> {place.location} </p>
                                </div>
